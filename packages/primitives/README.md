...
```bash
bun add @square-experience/primitives @square-experience/tokens
# or
npm install @square-experience/primitives @square-experience/tokens
```
...
1. **Configure Tailwind**
   ...
   export default {
     ...
     content: [
       './src/**/*.{ts,tsx}',
       './node_modules/@square-experience/primitives/dist/**/*.{js,ts}'
     ],
   };
   ```
...
```tsx
import { Button, Card, Dialog, Input, Badge } from '@square-experience/primitives';
...
```tsx
import { buttonVariants } from '@square-experience/primitives';
